...
<!--[if lt IE 9]>
        <script src="views/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
    <![endif]-->
<!--[if lte IE 8]>
		<script type="text/javascript" src="views/http://explorercanvas.googlecode.com/svn/trunk/excanvas.js"></script>
	<![endif]-->
...
<div id="#top"></div>
<section id="home">
  <div class="banner-container"> <img src="views/images/banner-bg.jpg" alt="banner" />
...
<div class="row">
	<div class="col-md-3 col-sm-6">
		<div class="exp-wrapper">
			<img src="views/images/client-1.png" width="90" alt="Name">
			<h3>Work Day Look</h3>
	...
	<div class="col-md-3 col-sm-6">
		<div class="exp-wrapper">
			<img src="views/images/client-5.png" width="90" alt="Name">
			<h3>Yahoo</h3>
			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been. </p>
		</div>
	</div>
	<div class="col-md-3 col-sm-6">
		<div class="exp-wrapper">
			<img src="views/images/client-3.png" width="90" alt="Name">
			<h3>jQuery</h3>
			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
		</div>
	</div>
	<div class="col-md-3 col-sm-6">
		<div class="exp-wrapper">
			<img src="views/images/client-4.png" width="90" alt="Name">
			<h3>Flickr</h3>
			<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
		</div>
	</div>
        ...
        <div class="row">
          <div class="portfolio-items isotopeWrapper clearfix" id="3">
            <article class="col-sm-4 isotopeItem webdesign">
              <div class="portfolio-item"> <img src="views/images/portfolio/img1.jpg" alt="" />
            ...
            <article class="col-sm-4 isotopeItem photography">
              <div class="portfolio-item"> <img src="views/images/portfolio/img2.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem photography">
              <div class="portfolio-item"> <img src="views/images/portfolio/img3.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem print">
              <div class="portfolio-item"> <img src="views/images/portfolio/img4.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem photography">
              <div class="portfolio-item"> <img src="views/images/portfolio/img5.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem webdesign">
              <div class="portfolio-item"> <img src="views/images/portfolio/img6.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem print">
              <div class="portfolio-item"> <img src="views/images/portfolio/img7.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem photography">
              <div class="portfolio-item"> <img src="views/images/portfolio/img8.jpg" alt="" />
                <div class="portfolio-desc align-center">
            ...
            <article class="col-sm-4 isotopeItem print">
              <div class="portfolio-item"> <img src="views/images/portfolio/img9.jpg" alt="" />
                <div class="portfolio-desc align-center">
...
<script src="views/views/js/modernizr-latest.js"></script>
<script src="views/views/js/jquery-1.8.2.min.js" type="text/javascript"></script>
<script src="views/views/js/bootstrap.min.js" type="text/javascript"></script>
<script src="views/views/js/jquery.isotope.min.js" type="text/javascript"></script>
<script src="views/views/js/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
<script src="views/views/js/jquery.nav.js" type="text/javascript"></script>
<script src="views/views/js/jquery.cslider.js" type="text/javascript"></script>
<script src="views/views/js/jquery.diagram.js"></script>
 <script src="views/views/contact/jqBootstrapValidation.js"></script>
 <script src="views/views/contact/contact_me.js"></script>
<script src="views/views/js/custom.js" type="text/javascript"></script>
<script src="views/views/js/owl-carousel/owl.carousel.js"></script>
</body>
</html>
