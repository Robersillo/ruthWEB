...
<section id="contactUs" class="page-section secPad">
  <div class="container">
    ...
    <div class="row mrgn30">
		...
		data-validation-required-message="Porfavor inserta tu nombre completo" />
		...
		id="email" required
		data-validation-required-message="Porfavor inserta tu email" />
		</div>
		</div>
		...
		data-validation-required-message="Porfavor inserta tu mensaje" minlength="5"
